...
const MODES = [
  {
    ...
    label: "Fácil",
    tag: "MODO BÁSICO",
    desc: "Constructores, objetos y clases en su forma más pura. Hay pistas si la riegas — porque hasta el compilador perdona errores de novato. Ideal pa' calentar el CPU antes de que la herencia te explote en la cara.",
    chips: ["30 seg", "Pistas incluidas", "Clases y Objetos"],
    color: "#10b981",
    art: "</>",
    lives: null,
    maxTime: 30,
  },
  {
    ...
    label: "Normal",
    tag: "MODO ESTÁNDAR",
    desc: "Herencia, polimorfismo y encapsulamiento sin red de seguridad. Sin pistas, sin acordeón, sin instanciar excusas. El modo que separa a los que entienden POO de los que la copian del ChatGPT.",
    chips: ["30 seg", "Sin pistas", "Herencia + Polimorfismo"],
    color: "#6366f1",
    art: "{ }",
    lives: null,
    maxTime: 30,
  },
  {
    ...
    label: "Heroico",
    tag: "MODO ÉLITE",
    desc: "Sobreescritura de métodos, encapsulamiento con validación y polimorfismo con trampas de lógica. Tienes 3 vidas en el server — el garbage collector no recoge tus errores aquí.",
    chips: ["30 seg", "3 Vidas", "Sobreescritura + Trampas"],
    color: "#f59e0b",
    art: "❤️",
    lives: 3,
    maxTime: 30,
  },
  {
    ...
    label: "Legendario",
    tag: "MODO CRÍTICO",
    desc: "Muerte súbita. 15 segundos. Un SUPER() mal usado o un private fuera de lugar y todo se va al null. Solo pa' los que ya tienen polimorfismo en la sangre. El server no acepta excusas.",
    chips: ["15 seg", "Muerte Súbita", "Solo POO Avanzado"],
    color: "#f43f5e",
    art: "null",
    lives: 1,
    maxTime: 15,
